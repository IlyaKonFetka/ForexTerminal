...
public class Buy extends Command implements MonetaryTransaction {
    ExchangeService exchangeService;
    public Buy(ExchangeService exchangeService) {
        super(
                "buy",
                "<amount_to_buy> <currency_to_sell> <currency_to_buy>",
                "Покупка валюты"
        );
    ...
    public String makeKeyPhrase(String[] parameters) {
        return "Покупка " + parameters[0] + " " + parameters[2] + " в обмен на " + parameters[1];
    }
}
